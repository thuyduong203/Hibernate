 ...
 */
package com.mycompany.viewThiThu;
...
public class ViewSP1810 extends javax.swing.JFrame {
    ...
    private List<CTSPCustomThiThu> listCTSP = new ArrayList<>();
    ...
    public ViewSP1810() {
        ...
        listCTSP = chiTietSanPhamServiceImpl.getAllCustomThiThu();
        showData(listCTSP);
        loabCBbb();
    }

    private void showData(List<CTSPCustomThiThu> listCTSP) {
        dtmSanPham.setRowCount(0);
        for (CTSPCustomThiThu cTSPViewModel1810 : listCTSP) {
    ...
    private void fill(int index, List<CTSPCustomThiThu> listCTSP) {
        CTSPCustomThiThu cTSPCustomThiThu = listCTSP.get(index);
        txtGiaNhap.setText(String.valueOf(cTSPCustomThiThu.getGiaNhap()));
        txtMoTa.setText(cTSPCustomThiThu.getMoTa());
        txtNamBH.setText(String.valueOf(cTSPCustomThiThu.getNamBH()));
        txtSLTon.setText(String.valueOf(cTSPCustomThiThu.getSlTon()));
    }
    ...
    private void initComponents() {
        ...
        txtNamBH.getAccessibleContext().setAccessibleName("0");
        txtNamBH.getAccessibleContext().setAccessibleDescription("");
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        //  List<CTSPCustomThiThu> listCTSPDomain = chiTietSanPhamServiceImpl.getByNamBH(namBHSearch);
        listCTSP = chiTietSanPhamServiceImpl.getByNamBH(namBHSearch);
        showData(listCTSP);
