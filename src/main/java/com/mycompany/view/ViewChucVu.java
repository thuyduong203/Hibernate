...
public class ViewChucVu extends javax.swing.JFrame {
    ...
    private ChucVuServiceImpl chucVuServiceImpl = new ChucVuServiceImpl();
    private List<ChucVuCustomModel> listCVCustom = new ArrayList<>();
...
//        listCV = chucVuServiceImpl.getAll();
//        showData(listCV);
        listCVCustom = chucVuServiceImpl.getAllCustom();
        showData(listCVCustom);
    }

    private void showData(List<ChucVuCustomModel> listCV) {
        dtmChucVu.setRowCount(0);
        for (ChucVuCustomModel chucVuCustomModel : listCV) {
            dtmChucVu.addRow(chucVuCustomModel.toDataRow());
        }
    }

    private void fill(int index, List<ChucVuCustomModel> listCV) {
        ChucVuCustomModel cv = listCV.get(index);
    ...
    private void tblChucVuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChucVuMouseClicked
        int check = tblChucVu.getSelectedRow();
        fill(check, listCVCustom);
    }//GEN-LAST:event_tblChucVuMouseClicked

    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ChucVu chucVu = newChucVu();
        JOptionPane.showMessageDialog(this, chucVuServiceImpl.add(chucVu));
//        listCV = chucVuServiceImpl.getAll();
//        showData(listCV);
        listCVCustom = chucVuServiceImpl.getAllCustom();
        showData(listCVCustom);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (index < 0) {
            ...
            ChucVu chucVu = newChucVu();
            String id = listCVCustom.get(index).getIdCV();
            JOptionPane.showMessageDialog(this, chucVuServiceImpl.update(chucVu, id));
//            listCV = chucVuServiceImpl.getAll();
//            showData(listCV);
            listCVCustom = chucVuServiceImpl.getAllCustom();
            showData(listCVCustom);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (index < 0) {
            ...
            String id = listCVCustom.get(index).getIdCV();
            JOptionPane.showMessageDialog(this, chucVuServiceImpl.delete(id));
//            listCV = chucVuServiceImpl.getAll();
//            showData(listCV);
            listCVCustom = chucVuServiceImpl.getAllCustom();
            showData(listCVCustom);
