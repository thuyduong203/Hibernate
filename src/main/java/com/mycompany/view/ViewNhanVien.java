...
import com.mycompany.service.impl.ChucVuServiceImpl;
import com.mycompany.service.impl.CuaHangServiceImpl;
...
public class ViewNhanVien extends javax.swing.JFrame {
    ...
    private List<NhanVienCustomModel> listNVCustom = new ArrayList<>();
    ...
    public ViewNhanVien() {
        ...
        setCbb();
        String headers[] = {"Mã NV", "Tên NV", "Tên CH", "Chức vụ", "Người gửi báo cáo"};
        dtmHienThi.setColumnIdentifiers(headers);
        listNVCustom = nvSVImpl.getAllCustom();
        showData(listNVCustom);
    }

    private void setCbb() {
        listCH = cuaHangSVImpl.getAll();
        listCV = chucVuImpl.getAll();
        listGuiBC = nvSVImpl.getAll();
    ...
    public void showData(List<NhanVienCustomModel> listNV) {
        dtmHienThi.setRowCount(0);
        for (NhanVienCustomModel nhanVienCustomModel : listNV) {
            dtmHienThi.addRow(nhanVienCustomModel.toDataRow());
        }
    }
    ...
    private NhanVien newNhanVien() {
        ...
        cuaHang.setIdCH(cbbCuaHang.getSelectedItem().toString());
        ChucVu chucVu = new ChucVu();
        chucVu.setIdCV(cbbChucVu.getSelectedItem().toString());
        NhanVien guiBC = new NhanVien();
        if (cbbGuiBC.getSelectedItem() != null) {
            guiBC.setIdNV(cbbGuiBC.getSelectedItem().toString());
        }
    ...
    private void fill(int index, List<NhanVienCustomModel> listNV) {
        NhanVienCustomModel nv = listNV.get(index);
        txtMa.setText(nv.getMaNV());
        txtTen.setText(nv.getTenNV());
        txtTenDem.setText(nv.getTenDem());
        txtHo.setText(nv.getHoNV());
        txtGtinh.setText(nv.getGioiTinh());
        txtNgaySinh.setText(String.valueOf(nv.getNgaySinh()));
        txtDiaChi.setText(nv.getDiaChi());
        txtSDT.setText(nv.getSdt());
        txtMatKhau.setText(nv.getMatKhau());
//        cbbCuaHang.setSelectedItem("...");
...
//        cbbGuiBC.setSelectedItem(nv.getNguoiGuiBC().getIdNV());
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cbbGuiBC, 0, 276, Short.MAX_VALUE)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(12, 12, 12)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        JOptionPane.showMessageDialog(this, nvSVImpl.add(nhanVien));
        listNVCustom = nvSVImpl.getAllCustom();
        showData(listNVCustom);
    }//GEN-LAST:event_btnAddActionPerformed

    private void btbUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btbUpdateActionPerformed
        int row = tblHienThiNV.getSelectedRow();
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "????");
        } else {
            String idNV = listNVCustom.get(row).getIdNV();
            NhanVien nhanVien = newNhanVien();
            JOptionPane.showMessageDialog(this, nvSVImpl.update(nhanVien, idNV));
            listNVCustom = nvSVImpl.getAllCustom();
            showData(listNVCustom);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (row < 0) {
            ...
            String idNV = listNVCustom.get(row).getIdNV();
            JOptionPane.showMessageDialog(this, nvSVImpl.delete(idNV));
            listNVCustom = nvSVImpl.getAllCustom();
            showData(listNVCustom);
        }
