...
public class ViewCuaHang extends javax.swing.JFrame {
    ...
    private List<CuaHangCustomModel> listCHCustom = new ArrayList<>();
...
//        listtCH = cuaHangSVImpl.getAll();
//        showData(listtCH);
        listCHCustom = cuaHangSVImpl.getAllCustom();
        showData(listCHCustom);
    }

    private void showData(List<CuaHangCustomModel> listCH) {
        dtmCuaHang.setRowCount(0);
        for (CuaHangCustomModel cuaHangCustomModel : listCH) {
            dtmCuaHang.addRow(cuaHangCustomModel.toDataRow());
        }
    }

    private void fill(int index, List<CuaHangCustomModel> listCH) {
        CuaHangCustomModel ch = listCH.get(index);
    ...
    private void tblCuaHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCuaHangMouseClicked
        ...
        fill(index, listCHCustom);
    }//GEN-LAST:event_tblCuaHangMouseClicked

    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        CuaHang ch = newCuaHang();
        JOptionPane.showMessageDialog(this, cuaHangSVImpl.add(ch));
//        listtCH = cuaHangSVImpl.getAll();
//        showData(listtCH);
        listCHCustom = cuaHangSVImpl.getAllCustom();
        showData(listCHCustom);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (index < 0) {
            ...
            String id = listCHCustom.get(index).getIdCH();
            CuaHang cuaHang = newCuaHang();
            JOptionPane.showMessageDialog(this, cuaHangSVImpl.update(cuaHang, id));
//            listtCH = cuaHangSVImpl.getAll();
//            showData(listtCH);
            listCHCustom = cuaHangSVImpl.getAllCustom();
            showData(listCHCustom);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (index < 0) {
            ...
            String id = listCHCustom.get(index).getIdCH();
            JOptionPane.showMessageDialog(this, cuaHangSVImpl.delete(id));
//            listtCH = cuaHangSVImpl.getAll();
//            showData(listtCH);
            listCHCustom = cuaHangSVImpl.getAllCustom();
            showData(listCHCustom);
