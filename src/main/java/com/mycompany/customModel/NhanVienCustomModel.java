...
public class NhanVienCustomModel {
    ...
    public NhanVienCustomModel(String idNV, String maNV, String tenNV, String tenDem, String hoNV, String gioiTinh, String sdt, String matKhau, String tenCH, String tenCV, String maNguoiGuiBC, int trangThai, Date ngaySinh, String diaChi) {
        this.idNV = idNV;
        this.maNV = maNV;
        this.tenNV = tenNV;
        this.tenDem = tenDem;
